...
export default function Profile() {
  ...
  async function HandleSignOut() {
    try {
      ...
      const res = await fetch('https://e-backend-dps3pnj58-harshit-singh-aryas-projects.vercel.app/api/auth/signout', {
        method: 'POST',
        headers: {
  ...
  async function HandleDelete() {
    try {
      ...
      const res = await fetch(`https://e-backend-dps3pnj58-harshit-singh-aryas-projects.vercel.app/api/auth/delete/${currentUser._id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json'
        }
